...
/* harmony import */ var rss_parser__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(6946);
/* harmony import */ var rss_parser__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__nccwpck_require__.n(rss_parser__WEBPACK_IMPORTED_MODULE_1__);
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // })
            const rss = new rss_parser__WEBPACK_IMPORTED_MODULE_1__();
            let feed = yield rss.parseURL('https://andrewlock.net/rss.xml');
